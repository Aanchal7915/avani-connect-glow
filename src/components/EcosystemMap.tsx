...
const EcosystemMap = () => {
    ...
    const projects: EcosystemItem[] = [
        ...
        { id: 'p3', name: 'FRD Nutrition', image: '/frd.jpeg', link: '/projects/frd-nutrition', type: 'project' },
        ...
        <div className="relative py-12">
            ...
            <div className="text-center mb-12">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-300/30 px-6 py-2 rounded-full mb-4"
                >
                    <Sparkles className="w-4 h-4 text-amber-600" />
                    <span className="text-sm font-bold text-amber-900 uppercase tracking-wider">Our Digital Ecosystem</span>
                </motion.div>
                <motion.h2
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    {services.map((item, index) => (
                        ...
                        >
                            <Link
                                ...
                                className={`block p-4 rounded-2xl border-2 bg-gradient-to-br ${getCardColor(item.type)} backdrop-blur-sm transition-all duration-300 ${isConnected(item.id) ? 'scale-105 shadow-lg shadow-blue-200' : 'hover:scale-105'
